#!/usr/bin/env python3
"""
Teste completo do Sr Burns com scraper corrigido
"""
...
async def test_sr_burns_complete():
    ...
    async with get_db_session() as session:
        ...
        snapshots = await session.execute(
            text("SELECT id, scraped_at, level, experience FROM character_snapshots WHERE character_id = 314 ORDER BY scraped_at DESC LIMIT 5")
        )
