...
# =============================================================================
# SCRIPT TEMPORÁRIO - ADIÇÃO EM MASSA DE PERSONAGENS (VERSÃO CORRIGIDA V3)
# =============================================================================
...
test_api_connectivity() {
    ...
    if ! test_endpoint "$API_URL/api/v1/characters/scrape-and-create" "POST" "server=taleon&world=san&character_name=test"; then
...
# Função principal
main() {
    log "=== INICIANDO ADIÇÃO EM MASSA DE PERSONAGENS (VERSÃO CORRIGIDA V3) ==="
