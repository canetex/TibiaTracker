...
# =============================================================================
# SCRIPT SIMPLES PARA ATUALIZAR SERVIDOR
# =============================================================================
...
wget -O Scripts/Deploy/update-server-simple.sh $GITHUB_RAW/Scripts/Deploy/update-server-simple.sh
...
chmod +x Scripts/Deploy/update-server-simple.sh
